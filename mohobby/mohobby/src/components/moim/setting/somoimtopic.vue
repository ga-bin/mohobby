    ...
    <div>
        <v-dialog v-model="check" max-width="600px">
            ...
            <v-sheet elevation="10" rounded="xl">
                ...
                <div class="pa-12">
                    <!-- 취미 hobb -->
                    <v-chip-group active-class="light-green--text" column>
                        <div>
                            <div class="mt-3">
                    ...
                    <v-card-actions class="justify-center mr-5">
                        <v-btn depressed elevation="2" @click="check = false">
                            취소
                        </v-btn>
                        <v-btn color="success" depressed elevation="2" @click="check = false">
                            저장
                        </v-btn>
                    </v-card-actions>
                </div>
