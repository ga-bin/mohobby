<template>
  <div class="mx-auto" style="width:800px; height:500px;">
    <v-card outlined>
      ...
      <input multiple="multiple" name="files[]" id="files" type="file" onchange="changeImage()" style="display:none"/>
                    ...
                    <div class="room-file-upload-example">
                        ...
                        <div class="room-file-notice-item room-file-upload-button">
                            <div class="image-box">
                                ...
                                <input type="file" name="file" id="file" ref="files" accept="image/png, image/jpeg, image/jpg" @change="onImageChange" multiple />
                            </div>
                        </div>
...
*/
      ...
      //이미지 미리보기
      onImageChange() {
        console.log(this.$refs.files.files); //파일이름, 마지막 수정날짜 등등
    ...
    uploadImage() {
      ...
      let frm = document.getElementById("feedInsert");
      let file = document.getElementById("file");

      const formData = new FormData(frm);   // 파일을 전송할때는 FormData 형식으로 전송

      //formData.append("fileList", file.files);
