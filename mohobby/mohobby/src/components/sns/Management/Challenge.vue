...
<p class="caption">
    <a href="https://www.ditdot.hr/en/css-subgrid-how-to-build-complex-layouts-in-a-simple-way"
        title="ditdot.hr" target="_blank">Visit how-to article on our blog</a>
</p>
</div>
    </div>
  </template>
