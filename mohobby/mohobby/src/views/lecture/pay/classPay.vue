  ...
  <div style="margin: 20px 40px">
    ...
    <v-stepper v-model="e1" flat>
      <v-stepper-header>
        ...
        <v-stepper-step step="3"> 결제하기 </v-stepper-step>
      </v-stepper-header>
      <v-stepper-items>
        ...
        <v-stepper-content step="3">
              ...
              <v-row class="d-flex align-center">
                <v-col cols="2">
                  <v-img
                    ...
                    width="150"
                    :src="
                      require(`@/assets/image/class/thumb/${classId}/1.jpg`)
                    "
                  />
                </v-col>
                <v-col cols="10">
          ...
          <v-card class="mt-5" outlined v-if="needsPickList.length != 0">
            <div class="ma-5">
            ...
            <div class="ma-5">
              ...
              <v-row>
                ...
                <v-col class="d-flex justify-end">
                  <h3>
                    {{
                      needsPickList.length == 0
                        ? "없음"
                        : needsPickPrice | comma | won
                    }}
                  </h3>
                </v-col>
              </v-row>
          ...
          <v-card class="mt-5" outlined>
            ...
            <v-row class="pb-10">
              <v-card
                ...
                outlined
                align="center"
                @click="payBtn('html5_inicis', 'card')"
              >
                카드결제
              </v-card>
              <v-card
                ...
                outlined
                align="center"
                @click="payBtn('html5_inicis', 'vbank')"
              >
                무통장입금
              </v-card>
              <v-card
...
export default {
  ...
  methods: {
    getNeedsList() {
      this.axios("/class/pay/needs/" + this.classId).then((res) => {
    ...
    payNaver() {
      ...
      IMP.request_pay(
        ...
        function (rsp) {
          //팝업 방식으로 진행 또는 결제 프로세스 시작 전 오류가 발생할 경우 호출되는 callback
          if (rsp.success) {
