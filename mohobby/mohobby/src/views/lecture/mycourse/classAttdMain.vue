            ...
            <div>
              <v-row class="d-flex justify-center">
                <v-img
                  ...
                  max-width="270"
                  :src="
                    require(`@/assets/image/class/thumb/${info.classId}/0.jpg`)
                  "
                ></v-img>
              </v-row>
              <v-row class="d-flex justify-center">
              ...
              <v-row class="d-flex justify-center mt-10">
                ...
                <v-btn
                  ...
                  @click="exitBtn"
                  v-if="
                    (info.attdDate && !info.leaveDate && !info.exitDate) ||
                    (info.outDate && !info.comebackDate) ||
                    (info.attdDate && !info.exitDate)
                  "
                >
                  퇴실
                </v-btn>
              ...
              <v-row class="d-flex justify-center pt-10">
                <v-col>
                  ...
                  <span>{{
                    info.attdDate == null
                      ? "00:00"
                      : $moment(info.attdDate).format("HH:mm")
                  }}</span>
                </v-col>
                ...
                <v-col>
                  ...
                  <span>{{
                    info.outDate == null
                      ? "00:00"
                      : $moment(info.outDate).format("HH:mm")
                  }}</span>
                </v-col>
                <v-divider vertical></v-divider>
                <v-col>
                  ...
                  <span>{{
                    info.comebackDate == null
                      ? "00:00"
                      : $moment(info.comebackDate).format("HH:mm")
                  }}</span>
                </v-col>
                <v-divider vertical></v-divider>
                <v-col>
                  ...
                  <span>{{
                    info.leaveDate == null
                      ? "00:00"
                      : $moment(info.leaveDate).format("HH:mm")
                  }}</span>
                </v-col>
              </v-row>
              <v-row class="d-flex justify-center pt-10">
                <v-col class="pl-10">
                  <v-avatar color="#1b243b" size="56">
