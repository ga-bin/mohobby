<template>
      ...
      >
        <v-expansion-panel-header class="panel-header" @click="changePanelHeader">
          <v-row justify="start" align="center">
            ...
            <div class="panel-header-text"><h3>{{ item.header }}</h3></div>
          </v-row>
  ...
  <v-bottom-navigation
    ...
    class="bottom-nav"
  >
    <v-btn class="d-flex justify-start">
      <v-icon color="white">mdi-chevron-left</v-icon>
      <span class="bottom-nav-text">이전학습</span>
    ...
    <v-btn class="d-flex justify-end">
      ...
      <span class="bottom-nav-text">다음학습</span>
