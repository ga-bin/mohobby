      ...
      <v-container fluid style="margin-top: 0px">
        <v-card class="mx-auto" min-width="600">
          ...
          <v-row>
            <v-col cols="12" id="image_box" style="position: relative">
              <v-icon v-show="imgsLength == 2" class="image_icon"
                >mdi-numeric-2-box-multiple</v-icon
              >
              <v-icon v-show="imgsLength == 3" class="image_icon"
                >mdi-numeric-3-box-multiple</v-icon
              >
              <v-icon v-show="imgsLength == 4" class="image_icon"
                >mdi-numeric-4-box-multiple</v-icon
              >
              <v-icon v-show="imgsLength == 5" class="image_icon"
                >mdi-numeric-5-box-multiple</v-icon
              >
          ...
          <v-row>
            ...
            <v-col cols="8">
              ...
              <div class="d-flex justify-end ma-2">
                ...
                <v-btn
                  v-if="mark === 1"
                  @click="bookmarkDel(items.postId, memberId)"
                  icon
                >
        ...
        -->
         ...
         -->
          <v-col cols="12">
            <CmtReg
              @cmtCount="cmtAllCount"
              :postid="postId"
              :targetId="items.memberId"
            />
          </v-col>
        </v-card>
      </v-container>
  ...
  methods: {
    ...
    */
    ...
    search(e) {
      ...
      this.$router.push({
        name: "snsmain",
        params: { detailHashtag: getHashtag },
      });
    },
    ...
    like(memberId, postId) {
      ...
      this.stompClient.send(
        ...
        (res) => {
          console.log("좋아요 알림 전송"), console.log(res);
        }
      );
